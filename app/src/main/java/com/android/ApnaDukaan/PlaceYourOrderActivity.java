...
import com.android.ApnaDukaan.adapters.OrderAdapter;
import com.android.ApnaDukaan.model.Menu;
...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    private void initRecyclerView(RestaurantModel restaurantModel) {
        ...
        orderAdapter = new OrderAdapter(restaurantModel.getMenus());
        cartItemsRecyclerView.setAdapter(orderAdapter);
    }
